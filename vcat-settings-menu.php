...
function vcat_geo_map_headline() {
  _e( 'Here you can edit the standard settings for the Big Map. The width and height steer the size of the map. The center and zoom can be used to change the standard alignment. The target sets the attribute of the anchor-tag.', 'vcgmapsatposts' );
}
...
function vcat_geo_map_centerbox() {
	...
	?>
		<label>
			<input type='checkbox' value='TRUE' name='vcat_geo_center[dynamic]' <?php checked( $center['dynamic'], 'TRUE' ); ?> ><span><?php _e( "dynamic", "vcgmapsatposts" ); ?></span>
		</label>
	<?php
...
function vcat_geo_map_zoombox() {
	...
	$center = get_option( 'vcat_geo_center', $VCAT_MAP_DEFAULTS['center'] );
	?>
		<div id="zoom-slider<?php echo ( $center['dynamic'] == 'TRUE' ) ? " disappear" : ""; ?>"></div>
		<input id='zoom' name='vcat_geo_zoom[zoom]' value=' <?php echo $zoom['zoom']; ?> ' type='text' readonly />
	<?php
...
function vcat_geo_map_targetbox() {
	...
	?>
		<label>
			<input type="radio" name="vcat_geo_target[target]" value="blank" <?php checked( $target['target'], "blank" ); ?>><span> <?php _e( 'New Window/New Tab', 'vcgmapsatposts' ) ?></span>
		</label>
		<br>
		<label>
			<input type="radio" name="vcat_geo_target[target]" value="top" <?php checked( $target['target'], "top" ); ?>><span> <?php _e( 'Active Window', 'vcgmapsatposts' ); ?></span>
		</label>
	<?php
}
...
function vcat_geo_map_alignbox() {
	...
	?>
	<label>
		<input type="radio" name="vcat_geo_align[align]" value="left" <?php checked( $align['align'], "left" ); ?>><span> <?php _e( 'left', 'vcgmapsatposts' ) ?></span>
	</label>
	<br>
	<label>
		<input type="radio" name="vcat_geo_align[align]" value="right" <?php checked( $align['align'], "right" ); ?>><span> <?php _e( 'right', 'vcgmapsatposts' ); ?></span>
	</label>
	<?php
}
...
function vcat_geo_mini_map_headline() {
	_e( 'Here you can edit the standard settings for the Mini Map. The width and height steer the size of the map. The zoom can be used to change the standard alignment. The target sets the attribute of the anchor-tag.', 'vcgmapsatposts' );
}
...
function vcat_geo_mini_map_targetbox() {
	...
	?>
	<label>
		<input type="radio" name="vcat_geo_mini_target[target]" value="blank" <?php checked( $target['target'], "blank" ); ?>><span> <?php _e( 'New Window/New Tab', 'vcgmapsatposts' ) ?></span>
	</label>
	<br>
	<label>
		<input type="radio" name="vcat_geo_mini_target[target]" value="top" <?php checked( $target['target'], "top" ); ?>><span> <?php _e( 'Active Window', 'vcgmapsatposts' ); ?></span>
	</label>
	<?php
}
...
function vcat_geo_mini_map_alignbox() {
	...
	?>
	<label>
		<input type="radio" name="vcat_geo_mini_align[align]" value="left" <?php checked( $align['align'], "left" ); ?>><span> <?php _e( 'left', 'vcgmapsatposts' ) ?></span>
	</label>
	<br>
	<label>
		<input type="radio" name="vcat_geo_mini_align[align]" value="right" <?php checked( $align['align'], "right" ); ?>><span> <?php _e( 'right', 'vcgmapsatposts' ); ?></span>
	</label>
	<?php
}
